...
foreach(search ${_TensorRT_SEARCHES})
  find_library(NVINFER_PLUGIN_LIBRARY NAMES nvinfer_plugin ${${search}} PATH_SUFFIXES lib)
  find_library(NVONNXPARSER_LIBRARY NAMES nvonnxparser ${${search}} PATH_SUFFIXES lib)
  find_library(NVPARSER_LIBRARY NAMES nvparsers ${${search}} PATH_SUFFIXES lib)
endforeach()
...
if(TensorRT_FOUND)
  ...
  if(NOT TensorRT_LIBRARIES)
    set(TensorRT_LIBRARIES ${TensorRT_LIBRARY} ${NVINFER_PLUGIN_LIBRARY} ${NVONNXPARSER_LIBRARY} ${NVPARSER_LIBRARY})
  endif()
